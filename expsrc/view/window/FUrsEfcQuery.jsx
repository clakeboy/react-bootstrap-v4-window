...
class FUrsEfcQuery extends React.Component {
    constructor(props) {
        super(props);
        this.id = 'f_urs_efc_query';
    ...
    render() {
        return (
            <Form ref={c=>this.form=c} onChange={this.fieldChangeHandler}>
                <CTable jsxId={'sub_aec_query_general'} absolute={true} x={'20px'} y={'104px'} width={'780px'} height={'420px'} scroll={true} headerTheme={'light'} hover={true} select={false} sm={true} fontSm={true} source={'v_urs_log_query_general'}>
                ...
                <Input jsxId={'status_id'} field={'status_id'} size={'xs'} absolute={true} x={'128px'} y={'68px'} width={'92px'} align={'left'} combo={{
                ...
                <Label jsxId={'lbl_status_id'} sm={true} absolute={true} text={'Report Status'} x={'20px'} y={'68px'} width={'100px'} height={'20px'} align={'left'} color={'rgb(0,0,0)'}/>
                <Input jsxId={'urs_by_code'} field={'urs_by_code'} absolute={true} size={'xs'} x={'332px'} y={'68px'} width={'92px'} tabIndex={'3'} align={'left'}/>
                <Label jsxId={'Label24'} sm={true} absolute={true} text={'Report By'} x={'244px'} y={'68px'} width={'84px'} height={'20px'} align={'left'} color={'rgb(0,0,0)'}/>
                <Button jsxId={'btn1Open'} absolute={true} size={'xs'} x={'688px'} y={'44px'} width={'56px'} height={'40px'} outline={true} theme={'dark'}>
                    Open Item
                </Button>
                <Button jsxId={'btn1Close'} absolute={true} size={'xs'} x={'744px'} y={'44px'} width={'52px'} height={'40px'} outline={true} theme={'info'}>
                    Close Item
                </Button>
                <Input jsxId={'urs_type_code'} field={'urs_type_code'} size={'xs'} absolute={true} x={'332px'} y={'40px'} width={'92px'} align={'left'} combo={{
                ...
                <Label jsxId={'Label22'} sm={true} absolute={true} text={'Report Type'} x={'244px'} y={'40px'} width={'84px'} height={'20px'} align={'left'} color={'rgb(0,0,0)'}/>
                <Input jsxId={'export_agent_code'} field={'efc_group_code'} absolute={true} size={'xs'} x={'128px'} y={'40px'} width={'92px'} tabIndex={'6'} align={'left'}/>
                <Label jsxId={'lbl_company_name'} sm={true} absolute={true} text={'Company Code'} x={'20px'} y={'40px'} width={'104px'} height={'20px'} align={'left'} color={'rgb(0,0,0)'}/>
