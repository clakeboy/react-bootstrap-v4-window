...
class FEfcReleaseReview extends React.Component {
    constructor(props) {
        super(props);
        this.id = 'f_efc_release_review';
		this.title = 'EFC Release Review';
        if (!this.props.width) {
            this.width = '744px';
        }
    ...
    render() {
        return (
            <Form ref={c=>this.form=c} onChange={this.fieldChangeHandler}>
                <Tabs jsxId={'TabCtl774'} sm={true} border={true} absolute={true} x={'0px'} y={'28px'} width={'744px'} height={'500px'}>
                    <TabsContent jsxId={'Release Info'} id={'Release Info'} text={'Release Info'} active={true}>
                        <Input jsxId={'efc_release_no'} field={'efc_release_no'} absolute={true} size={'xs'} x={'128px'} y={'5px'} width={'104px'} tabIndex={'0'} align={'left'}/>
                        <Label jsxId={'Label719'} sm={true} absolute={true} text={'Release No.'} x={'20px'} y={'5px'} width={'100px'} height={'20px'} align={'left'} color={'rgb(0,0,0)'}/>
                        <Input jsxId={'sub_version_no'} field={'sub_version_no'} absolute={true} size={'xs'} x={'360px'} y={'33px'} width={'56px'} tabIndex={'1'} align={'left'}/>
                        <Label jsxId={'Label724'} sm={true} absolute={true} text={'Sub Version No.'} x={'248px'} y={'33px'} width={'104px'} height={'20px'} align={'left'} color={'rgb(0,0,0)'}/>
                        <Input jsxId={'est_release_date'} field={'est_release_date'} absolute={true} size={'xs'} x={'128px'} y={'33px'} width={'104px'} tabIndex={'2'} align={'left'} calendar={{format:'YYYY-MM-DD'}}/>
                        <Label jsxId={'Label728'} sm={true} absolute={true} text={'Release Date'} x={'20px'} y={'33px'} width={'100px'} height={'20px'} align={'left'} color={'rgb(0,0,0)'}/>
                        <Button jsxId={'btn1Undo'} absolute={true} size={'xs'} x={'644px'} y={'17px'} width={'52px'} height={'32px'} outline={true} theme={'info'}>
                            Undo
                        </Button>
                        <CTable jsxId={'sub_efc_release_list_work'} absolute={true} x={'20px'} y={'69px'} width={'704px'} height={'384px'} scroll={true} headerTheme={'light'} hover={true} select={false} sm={true} fontSm={true} source={'v_efc_release_list_work'}>
                    ...
                    <TabsContent jsxId={' Note'} id={' Note'} text={' Note'}>
                        <Box jsxId={'box_00_11'} absolute={true} x={'20px'} y={'89px'} width={'704px'} height={'364px'} borderWidth={'1px'} borderColor={'rgb(0,0,0)'}/>
                        <TextArea jsxId={'release_note'} field={'release_note'} absolute={true} size={'xs'} x={'36px'} y={'125px'} width={'672px'} tabIndex={'0'} height={'308px'}/>
                        ...
                        <Box jsxId={'Box803'} absolute={true} x={'20px'} y={'9px'} width={'704px'} height={'80px'} borderWidth={'1px'} borderColor={'rgb(0,0,0)'}/>
                    </TabsContent>
                </Tabs>
                <Box jsxId={'Box1137'} absolute={true} x={'0px'} y={'0px'} width={'600px'} height={'27px'} borderWidth={'1px'} borderColor={'rgb(0,0,0)'} backColor={'rgb(37,62,82)'}/>
                ...
                <Button jsxId={'btn0Add'} absolute={true} size={'xs'} x={'684px'} y={'0px'} width={'28px'} height={'24px'} outline={true} icon={'folder-plus'} theme={'dark'}>
                    
                </Button>
                <Button jsxId={'btn0Delete'} absolute={true} size={'xs'} x={'656px'} y={'0px'} width={'28px'} height={'24px'} outline={true} icon={'times-circle'} theme={'danger'}>
                    
                </Button>
                <Button jsxId={'btn0Clone'} absolute={true} size={'xs'} x={'628px'} y={'0px'} width={'28px'} height={'24px'} outline={true} icon={'clone'} theme={'dark'}>
                    
                </Button>
                <Button jsxId={'btn0Reload'} absolute={true} size={'xs'} x={'600px'} y={'0px'} width={'28px'} height={'24px'} outline={true} icon={'sync-alt'} theme={'success'}>
                    
                </Button>
                <Button jsxId={'btn0Edit'} absolute={true} size={'xs'} x={'712px'} y={'0px'} width={'28px'} height={'24px'} outline={true} icon={'edit'} theme={'success'}>
                    
                </Button>
                <Button jsxId={'btn0Save'} absolute={true} size={'xs'} x={'712px'} y={'0px'} width={'28px'} height={'24px'} outline={true} icon={'save'} theme={'success'}>
                    
                </Button>
                <Box jsxId={'Box1142'} absolute={true} x={'600px'} y={'0px'} width={'140px'} height={'27px'} borderWidth={'1px'} borderColor={'rgb(0,0,0)'}/>
                ...
                <Label jsxId={'Label808'} sm={true} absolute={true} text={'Status'} x={'164px'} y={'4px'} width={'52px'} height={'19px'} align={'left'} color={'rgb(255,255,255)'}/>
            </Form>
        );
    }
}

export default FEfcReleaseReview;
